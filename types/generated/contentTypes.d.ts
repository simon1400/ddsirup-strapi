...
export interface ApiContactPageContactPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    emailResponseInfo: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Private;
    phoneResponseInfo: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Homepage page content with dynamic sections';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    heroCategories: Schema.Attribute.Relation<
      'oneToMany',
      'api::category.category'
    >;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    billingAddress: Schema.Attribute.Component<'shop.address', false>;
    comgateStatus: Schema.Attribute.String;
    comgateTransId: Schema.Attribute.String & Schema.Attribute.Unique;
    ...
    customerFirstName: Schema.Attribute.String & Schema.Attribute.Required;
    customerForBar: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    customerForChildren: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
